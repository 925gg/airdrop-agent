...
export interface ClashStakingV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "calculateScore"
...
export interface ClashStakingV2 extends BaseContract {
  connect(runner?: ContractRunner | null): ClashStakingV2;
  waitForDeployment(): Promise<this>;

  interface: ClashStakingV2Interface;

...
export interface ChibiKingdomV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASE_STAT"
      | "COOLDOWN_TIME"
...
export interface ChibiKingdomV2 extends BaseContract {
  connect(runner?: ContractRunner | null): ChibiKingdomV2;
  waitForDeployment(): Promise<this>;

  interface: ChibiKingdomV2Interface;

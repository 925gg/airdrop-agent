...
export namespace TopPlayerRewardClaimedEvent {
  export type InputTuple = [
    eventId: BigNumberish,
    player: BytesLike,
    rewards: BigNumberish
  ];
  export type OutputTuple = [eventId: bigint, player: string, rewards: bigint];
  export interface OutputObject {
    eventId: bigint;
    player: string;
    rewards: bigint;
...
export interface ChibiKingdomRewards extends BaseContract {
  ...
  initialize: TypedContractMethod<
    [clashToken_: AddressLike, verifier_: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getEvent(
    key: "TopPlayerRewardClaimed"
  ): TypedContractEvent<
    TopPlayerRewardClaimedEvent.InputTuple,
    TopPlayerRewardClaimedEvent.OutputTuple,
    TopPlayerRewardClaimedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "TopPlayerRewardClaimed(uint256,bytes32,uint256)": TypedContractEvent<
      TopPlayerRewardClaimedEvent.InputTuple,
      TopPlayerRewardClaimedEvent.OutputTuple,
      TopPlayerRewardClaimedEvent.OutputObject
    >;
    TopPlayerRewardClaimed: TypedContractEvent<
      TopPlayerRewardClaimedEvent.InputTuple,
      TopPlayerRewardClaimedEvent.OutputTuple,
      TopPlayerRewardClaimedEvent.OutputObject
    >;

    "TopPlayerRewardsAdded(uint256,address[],uint256[])": TypedContractEvent<
      TopPlayerRewardsAddedEvent.InputTuple,
      TopPlayerRewardsAddedEvent.OutputTuple,
      TopPlayerRewardsAddedEvent.OutputObject
    >;

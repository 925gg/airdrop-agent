...
export interface IChibiKingdomV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "getKingdom"
      | "getLand"
...
export interface IChibiKingdomV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IChibiKingdomV3;
  waitForDeployment(): Promise<this>;

  interface: IChibiKingdomV3Interface;

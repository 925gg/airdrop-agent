...
export interface ClashStakingV4Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "calculateScore"
...
export interface ClashStakingV4 extends BaseContract {
  connect(runner?: ContractRunner | null): ClashStakingV4;
  waitForDeployment(): Promise<this>;

  interface: ClashStakingV4Interface;

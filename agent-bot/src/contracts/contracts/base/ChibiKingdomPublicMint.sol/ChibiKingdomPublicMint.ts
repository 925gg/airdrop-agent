...
export interface ChibiKingdomPublicMintInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "chibiKingdom"
  ...
  encodeFunctionData(
    functionFragment: "setLandBasePrice",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setPublicMintEnabled",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export interface ChibiKingdomPublicMint extends BaseContract {
  connect(runner?: ContractRunner | null): ChibiKingdomPublicMint;
  waitForDeployment(): Promise<this>;

  interface: ChibiKingdomPublicMintInterface;
  ...
  setLandBasePrice: TypedContractMethod<
    [price: BigNumberish],
    [void],
    "nonpayable"
  >;

  setPublicMintEnabled: TypedContractMethod<
    [enabled: boolean],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setLandBasePrice"
  ): TypedContractMethod<[price: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setPublicMintEnabled"

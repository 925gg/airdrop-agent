...
export interface ClashStakingV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "calculateScore"
  ...
  encodeFunctionData(
    functionFragment: "getTransactionByIds",
    values: [BigNumberish[]]
  ): string;
  encodeFunctionData(
...
export interface ClashStakingV3 extends BaseContract {
  connect(runner?: ContractRunner | null): ClashStakingV3;
  waitForDeployment(): Promise<this>;

  interface: ClashStakingV3Interface;
  ...
  getTransactionByIds: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "getTransactionByIds"
  ): TypedContractMethod<
    [transactionIds: BigNumberish[]],
    [TransactionWithIdStructOutput[]],
    "view"

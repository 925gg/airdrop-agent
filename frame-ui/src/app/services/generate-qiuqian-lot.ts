...
Input: User will provide the following information
  ...
  const parser = StructuredOutputParser.fromNamesAndDescriptions({
    ...
    lotNumber: "Lot number (decimal number only)",
    lotType:
      "The type (上籤 - Lucky Stick, 中籤 - Neutral Stick or下籤 - Unlucky Stick) corresponding to the lot number",
    lotContent:
    ...
    luckScore:
      "Assign a Luck score from 1 to 10, based on how well the fortune aligns with the user’s Zodiac sign and the current year’s energy. This distribution of Luck Score should ensure that higher Luck Scores (8-10) are more likely to come from lot type 上籤 (Lucky Stick) that represent success, positivity, or favorable outcomes, while lower Luck Scores (1-3) are tied to lot type 下籤 (Unlucky Stick)  that traditionally indicate challenges or obstacles, with probabilities that reflect a real life experience with qiuqian, and other Luck Scores (4-8) are for lot type 中籤 (Neutral Stick)",
    luckyTokens:

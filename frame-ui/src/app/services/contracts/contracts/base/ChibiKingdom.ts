...
export interface ChibiKingdomInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASE_STAT"
      | "COOLDOWN_TIME"
  ...
  encodeFunctionData(
    functionFragment: "LAND_PLOT_SUPPLY",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "remainingSlots",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ChibiKingdom extends BaseContract {
  connect(runner?: ContractRunner | null): ChibiKingdom;
  waitForDeployment(): Promise<this>;

  interface: ChibiKingdomInterface;
  ...
  LAND_PLOT_SUPPLY: TypedContractMethod<[], [bigint], "view">;
  ...
  remainingSlots: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "LAND_PLOT_SUPPLY"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "remainingSlots"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
